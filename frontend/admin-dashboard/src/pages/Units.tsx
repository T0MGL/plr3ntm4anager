  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-2xl font-semibold text-[#222222]">Units</h2>
          <p className="mt-1 text-sm text-[#717171]">Showcase listings, update details, and manage hosting readiness.</p>
        </div>
